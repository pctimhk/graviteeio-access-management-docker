...
main() {
    ...
    pushd $WORKDIR > /dev/null
        ...
        mkdir -p config
        curl -L https://raw.githubusercontent.com/pctimhk/graviteeio-access-management-docker/master/compose/docker-compose.yml -o "docker-compose.yml"
        curl -L https://raw.githubusercontent.com/pctimhk/graviteeio-access-management-docker/master/compose/.env -o ".env"
        cd config && { curl -L https://raw.githubusercontent.com/pctimhk/graviteeio-access-management-docker/master/compose/config/nginx.conf -o "nginx.conf" ; cd -; }
        echo
